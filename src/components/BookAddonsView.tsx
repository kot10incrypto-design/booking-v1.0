...
export const BookAddonsView: React.FC<BookAddonsViewProps> = ({
  ...
  const { activeChair, activeBarber } = useAtelier();
      ...
      <main className="flex-1 overflow-y-auto px-4 pb-36 pt-3" dir="rtl">
        ...
        <div className="mb-4 rounded-[24px] border border-white/80 bg-white/70 p-4 shadow-sm backdrop-blur-xl">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl bg-amber-50/80 px-2.5 py-1 text-center border border-amber-200/50">
              <span className="text-[9px] text-stone-500 block">مجری</span>
              <span className="text-[11px] font-bold text-stone-800">{activeBarber?.name}</span>
            </div>
          </div>
        </div>
