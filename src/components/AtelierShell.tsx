...
export const AtelierShell: React.FC<AtelierShellProps> = ({
  ...
  return (
    <div
      id={id}
      className={`relative w-full max-w-[420px] h-[100dvh] sm:h-[874px] sm:max-h-[94vh] mx-auto bg-gradient-to-b from-[#d3b3aa] via-[#ebd7ca] to-[#c4ab9d] overflow-hidden rounded-none sm:rounded-[36px] shadow-2xl flex flex-col justify-start border-0 sm:border sm:border-white/30 select-none ${className}`}
    >
