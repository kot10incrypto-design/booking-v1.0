...
import {
  AlertTriangle, ArrowRight, ChevronDown, ChevronUp, FolderPlus, Plus, Search,
} from 'lucide-react';
...
export const ServiceManagementView: React.FC<ServiceManagementViewProps> = ({ onBack }) => {
  const {
    categories, services, moveCategory, reorderCategories,
  ...
  return (
    <div className="min-h-screen bg-stone-50/50 pb-28 pt-4" dir="rtl">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-500">
                {toPersianDigits(categories.length)} دسته‌بندی · {toPersianDigits(services.length)} خدمت
              </p>
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="flex items-center gap-1 rounded-xl border border-stone-200 bg-white px-2.5 py-2 text-xs font-bold text-stone-700 hover:bg-stone-50"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-xl bg-[#7e5352] px-3 py-2 text-xs font-bold text-white shadow-sm hover:bg-[#6c4342]"
            >
