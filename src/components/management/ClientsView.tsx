        ...
        {filteredCustomers.length === 0 ? (
          <div className="p-8 text-center bg-white/60 backdrop-blur-md rounded-2xl border border-stone-200/60 space-y-2">
            ...
            <button
              ...
              className="mt-2 px-3 py-1 rounded-xl bg-stone-100 text-stone-700 text-[10px] font-bold hover:bg-stone-200"
            >
              پاک کردن فیلترها
            </button>
          </div>
          ...
          filteredCustomers.map((customer) => {
            ...
            return (
              <div
                ...
                className="p-3 rounded-2xl bg-white/75 hover:bg-white/95 backdrop-blur-md border border-white/80 hover:border-stone-300/80 cursor-pointer shadow-2xs hover:shadow-md transition-all space-y-2 group"
              >
                {/* Card Header */}
